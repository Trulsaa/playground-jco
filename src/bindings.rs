...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "scream"]
    unsafe extern "C" fn export_scream(arg0: *mut u8,arg1: usize,) -> *mut u8 {
      $($path_to_types)*::_export_scream_cabi::<$ty>(arg0, arg1)
    }
    #[export_name = "cabi_post_scream"]
    unsafe extern "C" fn _post_return_scream(arg0: *mut u8,) {
      $($path_to_types)*::__post_return_scream::<$ty>(arg0)
    }
  };);
}
#[doc(hidden)]
...
@\x01\x05inputs\0s\x04\0\x06scream\x01\0\x04\x01\x20component:playground-jco/exa\
